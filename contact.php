...
<link rel="stylesheet" type="text/css" href="css/contact_mobile.css" media="screen and (max-device-width:980px)"/>
...
<div class="contact_content">
   <div class="jn">
     <div class="jn_title"><img src="images/contact/zongbuliebiao.png"/>济南总部</div>index/slider
   	   <ul>
   	     <li>鹏野礼品济南总部</li>
   	     <li>电话：13505406066</li>
   	     <li>电子邮箱：360582946@qq.com</li>
   	     <li>地址：济南市槐荫区腊山北路9号5号楼</li>
   	   </ul>
   	  <iframe src= "contactMap_1.html" width="600" height="300" frameborder="0" scrolling="no"></iframe>
   </div>
   <div class="qd">
     <div class="qd_title"><img src="images/contact/fengongsi.png"/>青岛分公司</div>
   	   <ul>
   	     <li>鹏野礼品青岛分公司</li>
   	     <li>电话：18663954053</li>
   	     <li>电子邮箱：515715143@qq.com</li>
   	     <li>地址：青岛市李沧区万年泉路中海一里城8号楼</li>
   	   </ul>
      <iframe src= "contactMap_2.html" width="600" height="300" frameborder="0" scrolling="no"></iframe>
   </div>	
</div>
